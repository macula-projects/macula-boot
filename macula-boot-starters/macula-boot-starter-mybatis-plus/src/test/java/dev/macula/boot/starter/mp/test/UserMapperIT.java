...
public class UserMapperIT {
    ...
    public void allTests() throws Exception {
        ...
        user.setName("Tom");
        user.setAge(28);
        user.setEmail("test3@baomidou.com");
        userMapper.insert(user);
        user = new dev.macula.boot.starter.mp.test.entity.User();
        user.setName("Sandy");
        user.setAge(21);
        ...
        System.out.println("1=======" + userCrypto.getId() + " " + userCrypto.getEmail() + " " + userCrypto
            .getName() + " " + userCrypto.getVersion() + " " + userCrypto.getLastUpdateTime());
        ...
        System.out.println("1=======" + userKey.getId() + " " + userKey.getName() + " " + userKey
            .getVersion() + " " + userKey.getLastUpdateTime());
        ...
        System.out.println("2=======" + user2.getId() + " " + user2.getName() + " " + user2.getVersion() + " " + user2
            .getLastUpdateTime());
        ...
        System.out.println("3=======" + user3.getId() + " " + user3.getName() + " " + user3.getVersion() + " " + user3
            .getLastUpdateTime());
        User user4 = userMapper.selectById(userKey.getId());
        System.out.println("4======" + user4.getId() + " " + user4.getName() + " " + user4.getVersion() + " " + user4
            .getLastUpdateTime());
    }
}
