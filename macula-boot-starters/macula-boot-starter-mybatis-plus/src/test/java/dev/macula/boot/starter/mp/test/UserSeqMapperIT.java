...
import dev.macula.boot.starter.mp.test.entity.UserSeq;
import dev.macula.boot.starter.mp.test.mapper.UserSeqMapper;
...
/**
 * <b>UserSeqMapperIT</b> UserSeqMapper 集成测试类
 *
 * @author Rain
 * @since 2022-01-23
 */
...
public class UserSeqMapperIT {
    ...
    public void testKeyGen() {
        ...
        System.out.println("1=======" + user.getId() + " " + user.getName() + " " + user.getVersion() + " " + user
            .getLastUpdateTime());
