...
import dev.macula.boot.starter.oss.support.PathUtil;
...
public class WebDavFileStorage implements FileStorage {
    ...
    public void download(FileInfo fileInfo, Consumer<InputStream> consumer) {
        try (InputStream in = getClient().get(
            getUrl(fileInfo.getBasePath() + fileInfo.getPath() + fileInfo.getFilename()))) {
            consumer.accept(in);
        } catch (IOException e) {
    ...
    public void downloadTh(FileInfo fileInfo, Consumer<InputStream> consumer) {
        ...
        try (InputStream in = getClient().get(
            getUrl(fileInfo.getBasePath() + fileInfo.getPath()) + fileInfo.getThFilename())) {
            consumer.accept(in);
        } catch (IOException e) {
