...
public class AWSS3 extends AbstractFileStorage {
    ...
    public AWSS3(OssProperty ossProperty) {
        ...
        BasicAWSCredentials credentials =
            new BasicAWSCredentials(ossProperty.getAccessKey(), ossProperty.getSecretKey());
        AwsClientBuilder.EndpointConfiguration endpointConfiguration =
            new AwsClientBuilder.EndpointConfiguration(ossProperty.getEndpoint(), Regions.DEFAULT_REGION.getName());
    ...
    public OssResult upload(InputStream is, String filename, String objectName) throws Exception {
        ...
        return null == putObjRet ? null
            : OssResult.builder().bucketName(bucketName).objectName(objectName).versionId(putObjRet.getVersionId())
    ...
    public MultipartUploadResponse getUploadSignedUrl(String filename) {
        ...
        return null == url ? null
            : MultipartUploadResponse.builder().objectName(objectName).uploadUrl(url.toString()).build();
    }
