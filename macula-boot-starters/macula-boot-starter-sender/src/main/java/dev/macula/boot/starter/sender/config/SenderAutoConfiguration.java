...
import dev.macula.boot.starter.sender.support.JdbcTemplateBasedLocalMessageRepository;
import dev.macula.boot.starter.sender.support.LocalMessageRepository;
import dev.macula.boot.starter.sender.support.LocalTableBasedReliableMessageCompensator;
import dev.macula.boot.starter.sender.support.LocalTableBasedReliableMessageSender;
