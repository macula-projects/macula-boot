...
package dev.macula.boot.starter.task.powerjob.config;
...
public class PowerJobProperties {
    ...
    public static class Worker {
        ...
        /**
         * Akka port of Powerjob-worker, optional value. Default value of this property is 27777. If multiple
         * PowerJob-worker nodes were deployed, different, unique ports should be assigned. Deprecated, please use
         * 'port'
         */
        @Deprecated
        ...
        /**
         * Address(es) of Powerjob-server node(s). Ip:port or domain. Example of single Powerjob-server node:
         * <p>
         * 127.0.0.1:7700
         * </p>
        ...
        /**
         * Max length of response result. Result that is longer than the value will be truncated. {@link ProcessResult}
         * max length for #msg
         */
        private int maxResultLength = 8192;
        /**
         * If allowLazyConnectServer is set as true, PowerJob worker allows launching without a direct connection to the
         * server. allowLazyConnectServer is used for conditions that your have no powerjob-server in your develop env
         * so you can't startup the application
         */
        private boolean allowLazyConnectServer = false;
        /**
         * Max length of appended workflow context value length. Appended workflow context value that is longer than the
         * value will be ignored. {@link WorkflowContext} max length for #appendedContextData
         */
