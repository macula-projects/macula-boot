    ...
    <el-aside v-loading="showGrouploading" width="200px">
      <el-container>
        ...
        <el-main class="nopadding">
          <el-tree ref="group" :current-node-key="''" :data="group" :expand-on-click-node="false" :filter-node-method="groupFilterNode" :highlight-current="true"
                   class="menu" node-key="id"
    ...
    <el-container>
      <el-header>
        <div class="left-panel">
          ...
          <el-button :disabled="selection.length==0" plain type="primary" @click="reset_password">密码重置</el-button>

        </div>
        <div class="right-panel">
          <div class="right-panel-search">
            <el-input v-model="search.keywords" clearable placeholder="登录账号 / 姓名"></el-input>
            <el-button icon="el-icon-search" type="primary" @click="upsearch"></el-button>
          </div>
        </div>
      </el-header>
      <el-main class="nopadding">
        <scTable ref="table" :apiObj="apiObj" remoteFilter remoteSort stripe @selection-change="selectionChange">
          <el-table-column type="selection" width="50"></el-table-column>
          <el-table-column label="ID" prop="id" width="80"></el-table-column>
          <el-table-column column-key="filterAvatar" label="头像" width="80">
            <template #default="scope">
              <el-avatar :src="scope.row.avatar" size="small"></el-avatar>
            </template>
          </el-table-column>
          <el-table-column column-key="filterUserName" label="用户名" prop="username" width="150"></el-table-column>
          ...
          <el-table-column align="right" fixed="right" label="操作" width="160">
            <template #default="scope">
              <el-button-group>
                <el-button size="small" text type="primary" @click="table_show(scope.row, scope.$index)">查看
                </el-button>
