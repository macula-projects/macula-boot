                    ...
                    <tr v-for="(item,index) in filter" :key="index">
                      ...
                      <td v-if="showOperator">
                        <el-select v-model="item.operator" placeholder="运算符">
                          <el-option v-for="ope in item.field.operators || operator" :key="ope.value" :label="ope.label"
                      ...
                      <td>
                        ...
                        <!-- 标签 -->
                        <el-select v-if="item.field.type=='tags'" v-model="item.value"
                                   :placeholder="item.field.placeholder||'请输入'" allow-create default-first-option
                                   filterable multiple
